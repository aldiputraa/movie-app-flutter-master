...
import 'tiketpage.dart'; // Import halaman tiket
import 'disimpanpage.dart'; // Import halaman disimpan dari file terpisah
import 'tentangpage.dart'; // Import halaman tentang
import 'pengaturanpage.dart'; // Import halaman pengaturan
...
class MovieTicketBooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          MovieTicketBookingContent(), // Tubuh aplikasi berisi widget MovieTicketBookingContent.
    );
  }
...
// Kelas MovieTicketBookingContent merepresentasikan widget untuk menampilkan kartu film.
class MovieTicketBookingContent extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
